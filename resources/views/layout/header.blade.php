    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="/metronic8/demo1/../demo1/index.html" class="d-block">
                <img alt="" style="height:35px!important" class="h-30px" />
            </a>

        </div>
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            <div class="app-header-menu align-items-stretch" data-kt-drawer-activate="{default: true, lg: false}"
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                    ...
                    <div class="d-flex flex-column" style="margin-top:12px; margin-left:2px;">
                        <div class="fw-bolder d-flex align-items-center fs-5" style="color:#35C7FF;">Workspace Name
                            <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Free</span>
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-5">
                            <a href="/metronic8/demo1/../demo1/account/overview.html" class="menu-link px-5">My
                                Profile</a>
                        </div>
                        <div class="menu-item px-5">
                        ...
                        <div class="menu-item px-5">
                            <a href="/metronic8/demo1/../demo1/account/statements.html" class="menu-link px-5">My
                                Statements</a>
                        </div>
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="/metronic8/demo1/../demo1/account/settings.html" class="menu-link px-5">Account
                                Settings</a>
                        </div>
